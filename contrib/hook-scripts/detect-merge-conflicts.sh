...
# error message.
#
# $HeadURL: https://svn.apache.org/repos/asf/subversion/branches/1.14.x/contrib/hook-scripts/detect-merge-conflicts.sh $
# $LastChangedDate: 2013-04-11 03:38:26 +0100 (Thu, 11 Apr 2013) $
